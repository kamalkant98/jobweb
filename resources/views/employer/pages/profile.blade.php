                    ...
                    <div class="app-main__inner">
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a href="{{url('employer')}}"><button class="mb-2 mr-2 btn btn-danger"> <i class="fas fa-arrow-left"></i> Back </button></a>
                                </div>
                            </div>
                        </div>  
                        ...
                        <div class="card" style="padding:10px;">
                            <div class="card-body">
                                        ...
                                        <form class="" action="{{url('employer/update_profile')}}" method="post" enctype="multipart/form-data">
                                         @csrf
                                         ...
                                         <input type="hidden" name="oldcity" id="oldcity" value="{{$edit_employer->city ?? '' }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="coverimageproflie" style="background-image:url({{asset('assest/web/assest/images/cover_image/')}}/{{$edit_employer->cover_image ?? 'cover.png'}});">
                                                    <div class="input-group " >  
                                                            ...
                                                            <img class="imageprofile" src=" {{asset('assest/web/assest/images/profile_image/')}}/{{$edit_employer->profile_image ?? 'profile.jpg'}} ">
                                                            </div>
