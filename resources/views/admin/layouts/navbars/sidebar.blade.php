                            ...
                            <div class="app-sidebar__inner">
                                <ul class="vertical-nav-menu">
                                  <!--   <li class="app-sidebar__heading">Dashboards</li> -->
                                    <li>
                                        <a href="{{url('admin')}}" class="{{ Request::is(['admin','']) ? 'mm-active' : null }}">
                                 ...
                                 <!--    <li class="app-sidebar__heading">Users</li> -->
                                        <li  >
                                            <a href="{{url('admin/notification')}}" class="{{ Request::is(['admin/notification']) ? 'mm-active' : null }}">
                                       ...
                                       <li>
                                            <a href="{{url('admin/all_job')}}"  class="{{ Request::is(['admin/all_job','admin/add_job','admin/job/edit/*']) ? 'mm-active' : null }}">
