                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="card" style="padding:10px;">
                            <div class="card-body">
                                        ...
                                        <form class="" action="{{url('admin/create_employee')}}" method="post" enctype="multipart/form-data">
                                         @csrf
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <label for="employee_name" class="">Employer Name</label>
                                                        <input name="employee_name" id="employee_name" placeholder="Employee name" type="text" class="form-control @error('employee_name') is-invalid @enderror" value="{{old('employee_name')}}">
                                                        @error('employee_name')
                                                        <span class="help-block " style="color:red;">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        <label for="empolyee_password" class="">Employer password</label>
                                                        <input name="empolyee_password" id="empolyee_password" placeholder=" Employee password" type="password" class="form-control @error('empolyee_password') is-invalid @enderror" value="{{old('empolyee_password')}}" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <label for="employee_mobile" class="">Employer Mobile</label>
                                                        <input name="employee_mobile" id="employee_mobile" placeholder="+91" type="text" class="form-control @error('employee_mobile') is-invalid @enderror" value="{{old('employee_mobile') }}">
